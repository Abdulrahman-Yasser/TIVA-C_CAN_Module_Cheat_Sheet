...
//void CANIntHandler(void)
//{
//    uint32_t InterruptMsg, ui32status_TXRQ, ui32status_NEWDAT, ui32status_MSGVAL, INT_Status;  /* Declare a variable to store interrupt status. */
//    /* Read the CAN interrupt status to find the cause of the interrupt. */
...
//            ui32status_TXRQ = CANStatusGet(CAN0_BASE, CAN_STS_TXREQUEST);
//            ui32status_NEWDAT = CANStatusGet(CAN0_BASE, CAN_STS_NEWDAT);
//            ui32status_MSGVAL = CANStatusGet(CAN0_BASE, CAN_STS_MSGVAL);
//            /*
//             * In case it response to a Automatic Transmit Remote message
//             */
//            if(ui32status_TXRQ > 0){
//                InterruptMsg = 0;
//                while(ui32status_TXRQ > 0){
//                    ui32status_TXRQ = ui32status_TXRQ >> 1;
//                    InterruptMsg++;
//                }
//                ui32status_TXRQ = 0;
//            }else if(ui32status_NEWDAT > 0){
//                /*
//                 * In case it response to a remote message
//                 */
//                InterruptMsg = 0;
//                while(ui32status_NEWDAT > 0){
//                    ui32status_NEWDAT = ui32status_NEWDAT >> 1;
//                    InterruptMsg++;
//                }
//                ui32status_NEWDAT = 0;
//            }else if(ui32status_MSGVAL > 0){
//                /*
//                 * In case it response to a remote message
//                 */
//                InterruptMsg = 0;
//                while(ui32status_MSGVAL > 0){
//                    ui32status_MSGVAL = ui32status_MSGVAL >> 1;
//                    InterruptMsg++;
//                }
//                ui32status_MSGVAL = 0;
//            }
